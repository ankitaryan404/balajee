...
@section('content')
    ...
    <div class="searchbox_parentdiv">
      ...
      <div class="mobile_searchbox_div">
        <form action="" method="">
          <input onclick="showdiv()" type="text" placeholder="Search By City,Locality ,Project" />
          <div class="btn">
            <a href="javascript:void(0)" onclick="showdiv()"><i class="fa fa-search" aria-hidden="true"></i> </a>
          </div>
        </form>
      </div>
    </div>
    ...
    <div id="popularowner_Parent_div">
      ...
      @endphp
        ...
        <a href="detail/retail/{{$retail->slug}}">
          <div class="property_detail">
            <p>{{$retail->sup_b_area}} sqft</p>
            <p><b>&#8377; {{$inr}} sqft/m</b></p>
            <p>{{$retail->building_name}}, {{$retail->city_name}} , Bihar</p>
            <p>Ready to Move</p>
            <div class="overlay">
    ...
    <div id="top_projects_Parent_div">
      ...
      <div class="owl-carousel owl-theme">
        ...
        @php 
        $inr=inr($warehouse->rent_p_sq_ft);
      @endphp
        <div class="item">
        ...
        <a href="detail/warehouse/{{$warehouse->slug}}">
          <div class="property_detail">
            <p>Total Area {{$warehouse->total_area}}</p>
            <p><b>&#8377; {{$inr}} per sqft</b></p>
            <p>{{$warehouse->building_name}}, {{$warehouse->city_name}} , Bihar<br />Ready To Move</p>
            <div class="overlay">
              <a href="javascript:void(0)" class="buttn" onclick="open_cont_modal()">Contact Owner</a>
            </div>
          </div>
    ...
    <div id="trendingindelhi_Parent_div">
      ...
      <div class="owl-carousel owl-theme">
        ...
        @php 
        $inr=inr($residential->rent_p_month);
      @endphp
        <div class="item">
          ...
          <a href="detail/residential/{{$residential->slug}}">
          <div class="property_detail">
            <p>{{$residential->no_of_room}} BHK Apartment</p>
            <p><b>&#8377; {{$inr}}</b></p>
            <p>{{$residential->building_name}}, {{$residential->city_name}} , Bihar<br />Ready To Move</p>
            <div class="overlay">
              <a href="javascript:void(0)" class="buttn" onclick="open_cont_modal()">Contact Owner</a>
            </div>
          </div>
    ...
    <div id="trendingindelhi_Parent_div">
      ...
      <div class="owl-carousel owl-theme">
        ...
        <div class="item">
          ...
          <a href="detail/plot/{{$plot->slug}}">
          <div class="property_detail">
            <p>{{$plot->no_of_room}} BHK Plot</p>
            <p><b>&#8377; {{$inr}}</b></p>
            <p>{{$plot->building_name}}, {{$plot->city_name}}, Bihar<br />Ready To Move</p>
            <div class="overlay">
              <a href="javascript:void(0)" class="buttn" onclick="open_cont_modal()">Contact Owner</a>
            </div>
          </div>
    ...
    <div class="postfree_parent_div">
      <div class="postfree_child_div">
        ...
        <a href="{{url('post-property')}}"><p><b>Post Property</b></p></a>
            <span><p>free</p></span>
          </span>
        </div>
      </div>
