...
<div class="commecial_prdct_parentdiv">
   ...
   @endphp
		...
		@empty
		<div class="not-found">
		<img src="{{asset('front_assets/images/not-found.png')}}" alt="BP Group" >
			<h2>No Data matches to your record</h2>
		</div>
		@endforelse
...
<p >{{count($property)}} owner warehouse property for sale in patna</p>
</div>
...
<div class="propertydiv_one">
	<div class="childdiv">
		...
		<div class="picandratediv">
			...
			<div class="ratediv">
				<p class="ratetext">Rs {{$inr}} sq/ft</p>
				<small>Warehouse Space</small>
				<p>{{$data->building_name}}<br>{{$data->address}}</p>
				<p>Ready to Move</p>
			</div>
		</div>
