                        ...
                        <div class="row">
                            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="text-center">
                                    <img src="{{ asset('storage/media/'.$detail['0']->images) }}" alt="User Avatar" class="rounded-circle user-avatar-xxl">
                                    </div>
                                </div>
                                    ...
                                    <div class="user-avatar-info">
                                        <div class="m-b-20">
                                            <div class="user-avatar-name">
                                                <h2 class="mb-1">{{$detail['0']->name}}</h2>
                                            </div>
                                        ...
                                        <div class="user-avatar-address">
                                            <p class="border-bottom pb-3">
                                                <span class="d-xl-inline-block d-block mb-2"><i class="fa fa-map-marker-alt mr-2 text-primary "></i>{{$detail['0']->address}}</span>
                                                <span class="mb-2 ml-xl-5 d-xl-inline-block d-block">Email Id : {{$detail['0']->email}} </span>
                                               
                                            </p>
                                            <div class="mt-3">
                                                <a href="#" class="badge badge-light mr-2">Contact Number : {{$detail['0']->contact_no}}</a> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
