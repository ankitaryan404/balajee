	...
	<div class="propertdetail_content_div">
		...
		<div class="propertyin_detail">
			<div class="property_img">
			 <a href="#"><img src="{{ asset('storage/media/'.$detail->banner_pic) }}"></a>	
			</div>
			...
			<div class="property_detail">
				...
				<div class="status_parent_div">
					...
					@isset($detail->floor_offer)
					<div class="column3">
						<p class="head">Floor</p>
						<p> {{$detail->floor_offer}}  (out of {{$detail->total_floor}} floors)</p>
					</div>
					@endisset
					@isset($detail->floor_offered)
					<div class="column3">
						<p class="head">Floor Offered</p>
						<p> {{$detail->floor_offered}}</p>
					</div>
					@endisset
					@isset($detail->total_area)
					<div class="column3">
						<p class="head">Total Area</p>
						 <p>{{$detail->total_area}}</p>
					</div>
					@endisset
					@isset($detail->total_floor)
					<div class="column3">
						<p class="head">Total Floor</p>
						 {{$detail->total_floor}}</p>
					</div>
					@endisset
				
					<div class="column4">
						<p class="head">Car parking</p>
						<p>@if ($detail->car_parking=='1')
							Yes		
							@else
							No
						@endif</p>
    ...
    <div class="saveproperty_ownerdetail_megadiv">
      ...
      <div class="savepropertydiv">
        <div class="savepropchild_div">
          <div class="imgdiv">
            <img src="{{ asset('front_assets/images/house.png') }}" alt="housepic">
          </div>
          <div class="textdiv">
