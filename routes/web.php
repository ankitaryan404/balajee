...
Route::post('contact', [FrontController::class, 'contact'])->name('user.contact');
Route::post('post', [FrontController::class, 'post'])->name('user.post');
Route::view('/congratulation','congratulations');
Route::get('details/{catId}/{slug}', [FrontController::class, 'details']);
...
Route::group(['middleware' => 'admin_auth'], function () {
    ...
    Route::get('admin/marketing-staff/detail/{slug}', [StaffController::class, 'detail']);


    Route::get('admin/user-enquiry', [AdminController::class, 'enquiry']);
